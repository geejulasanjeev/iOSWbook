...
public class ParallelLaunchApp {

	public static IOSDriver<MobileElement> driver;

	
	@Parameters({"deviceName_","UDID_","platformVersion_","wdaLocalPort_","URL_"})
	//@BeforeSuite
	@BeforeMethod
		//public void initialiseApplication(String port, String device) throws MalformedURLException{
		public static void initialiseApplication(String deviceName_,String UDID_,String platformVersion_,String wdaLocalPort_,String URL_) throws MalformedURLException, InterruptedException{
			...
			capabilities.setCapability("wdaLocalPort", wdaLocalPort_);
